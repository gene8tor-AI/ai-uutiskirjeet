...
<head>
    ...
    <style>
        ...
        .section-nav { display: flex; flex-wrap: wrap; justify-content: center; gap: 10px; margin: 20px 0 28px; }
        .section-nav a { display: inline-block; padding: 9px 13px; border: 1px solid #b8d5e8; border-radius: 20px; color: #0d4e7a; background: #f4fafc; font-size: 13px; }
        .section-nav a:hover { background: #e2f1f9; }
...
<body>
    <div class="container">
        ...
        <nav class="section-nav" aria-label="Siirry osioon">
            <a href="#katsaukset">Säännölliset katsaukset</a>
            <a href="#youtube-videot">YouTube videot</a>
            <a href="#hot-news">Hot News</a>
        </nav>
        <div class="content-grid">
            <div class="main-column">
                <h2 id="katsaukset" style="margin-bottom: 20px; color: #444; border-bottom: 2px solid #eee; padding-bottom: 10px;">Säännölliset katsaukset</h2>
                <ul>
"""
...
html_content += """                </ul>
                <h2 id="youtube-videot" style="margin: 34px 0 20px; color: #444; border-bottom: 2px solid #eee; padding-bottom: 10px;">▶ YouTube videot</h2>
...
html_content += """                </ul>
            ...
            <div class="sidebar-column">
                <h2 id="hot-news" style="margin-bottom: 20px; color: #dc2626; border-bottom: 2px solid #fecaca; padding-bottom: 10px;">🔥 Hot News -nostot</h2>
